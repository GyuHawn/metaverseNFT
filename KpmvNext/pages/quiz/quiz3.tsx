        ...
        <>
            <div>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item onClick={() => {setKind("it"); setSmShow3(true);}}> IT퀴즈 추가 </Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            </div>
            <div>
            <Modal
                    ...
                    <Button type="button" className='btn btn-secondary' data-bs-dismiss="modal" onClick={handleClose}>Close</Button>
                        <Button className='btn btn-primary' onClick={(e)=>{
                            Axios.get("http://localhost:3000/api/metaquiz?add3="+ipt1+"&ITexp1="+ipt2 + "&ITexp2="+ipt3 + "&ITexp3="+ipt4 + "&ITexp4="+ipt5 + "&ITcorrect=" + ipt6 + "&Kind=" + kind).then(()=>{setSmShow3(false);});
                        setSmShow3(false);
                        }}>Save</Button>
                    </Modal.Footer>
                    </Modal>
