...
- 회원정보 관리 창 구현 완료
- 퀴즈 카테고리별 관리 기능 1~2일 완료
- 배경, 맵, Obj 배치 관리 기능 미구현
- Nft Thohpy 이미지 선택 완료
...
- DB에서 상태 저장, 1일, 진행중.
- NFT 발행: 1일, 완료.
- 실시간 멀티플레이어 게임 구현; 멀티플레이어 전용 서버 개발; 접속, 탈퇴 기는 제공.
- 사용자 간 실시간 대화, 사용자별 캐릭터 이름과 색깔 표시.
- 네트워크 게임 흐름 최적화(끊김 현상 방지), 서버 주소 지정.
...
- Quiz category 설정 1~2, 완료
- 퀴즈우승자 데이터 전달 1~2, 완료
- login 및 데이터 저장 2~3, 진행중
